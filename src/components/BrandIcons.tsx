...
export const ElevenLabsIcon = ({ className = "h-5 w-5" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const GoogleCalendarIcon = ({ className = "h-5 w-5" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none">
    ...
    <rect x="10.5" y="16" width="3" height="3" rx="0.5" fill="currentColor"/>
  </svg>
);
